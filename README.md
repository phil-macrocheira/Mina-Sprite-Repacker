...
8) If you made a new mod, the structure is the same as `unpak`, but only include files that you are modding. Also include the `_my_sprites` folder, which should also include only sprites you are modding.
9) Modify sprites
